...
export abstract class ICommonService extends Service implements GameEventInterface {
    ...
    private _maxEnterBackgroundTime: number = GameConfig.MAX_INBACKGROUND_TIME;
    ...
    public set maxEnterBackgroundTime(value: number) {
        if (value < GameConfig.MIN_INBACKGROUND_TIME || value > GameConfig.MAX_INBACKGROUND_TIME) {
            value = GameConfig.MIN_INBACKGROUND_TIME;
        }
