...
export abstract class ICommonService extends Service implements IGameEventInterface {
    protected _maxEnterBackgroundTime: number = Macro.MAX_INBACKGROUND_TIME;
    ...
    public set maxEnterBackgroundTime(value: number) {
        if (value < Macro.MIN_INBACKGROUND_TIME || value > Macro.MAX_INBACKGROUND_TIME) {
            value = Macro.MIN_INBACKGROUND_TIME;
        }
