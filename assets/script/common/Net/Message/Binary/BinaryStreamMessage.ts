...
import { Message } from "../../../../framework/Support/Service/Codec/Codec";
import { StringToUtf8Array, Utf8ArrayToStr } from "../../../../framework/Utils/StringUtils";
...
class StreamValue<T> implements IStreamValue {
    ...
    get littleEndian() {
        return GameConfig.NETWORK_STREAM_USING_LITTLE_ENDIAN;
    }
}
...
export abstract class BinaryStream extends Message {
    ...
    private serializeArray(value: Array<any>, memberName: string, valueType: any, arrTypeOrMapKeyType: any, mapValueType: any) {
        //先写入数组的大小
        this._dataView.setUint32(this._byteOffset, value.length, GameConfig.NETWORK_STREAM_USING_LITTLE_ENDIAN);
    ...
    private serializeMap(value: Map<any, any>, memberName: string, valueType: any, arrTypeOrMapKeyType: any, mapValueType: any) {
        //先写入字典的大小
        this._dataView.setUint32(this._byteOffset, value.size, GameConfig.NETWORK_STREAM_USING_LITTLE_ENDIAN);
        this._byteOffset += Uint32Array.BYTES_PER_ELEMENT;
        value.forEach((dataValue, dataKey) => {
            ...
            if (arrTypeOrMapKeyType == String) {
                ...
                this._dataView.setUint32(this._byteOffset, dataKey, GameConfig.NETWORK_STREAM_USING_LITTLE_ENDIAN)
                this._byteOffset += Uint32Array.BYTES_PER_ELEMENT;
            }
            //写值
    ...
    private deserializeArray(memberName: any, memberType: any, arrTypeOrMapKeyType: any, mapValueType: any) {
        ...
        (<any>this)[memberName] = [];
        //先读数组大小
        let size = this._dataView.getUint32(this._byteOffset, GameConfig.NETWORK_STREAM_USING_LITTLE_ENDIAN);
        this._byteOffset += Uint32Array.BYTES_PER_ELEMENT;
    ...
    private deserializeMap(memberName: any, memberType: any, arrTypeOrMapKeyType: any, mapValueType: any) {
        ...
        for (let i = 0; i < size; i++) {
            ...
            if (arrTypeOrMapKeyType == String) {
                ...
                key = this._dataView.getUint32(this._byteOffset, GameConfig.NETWORK_STREAM_USING_LITTLE_ENDIAN)
                this._byteOffset += Uint32Array.BYTES_PER_ELEMENT;
            }
            //写值
...
export abstract class BinaryStreamMessage extends BinaryStream { }